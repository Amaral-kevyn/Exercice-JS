...
let returnThirdElement = function (array) {
 return (array.slice(2,3,).reverse().join(''));
}
...
let returnSentence = function (array) {
  let first = array['name'];
  let second = array['age'];
  let third = array['city'];
  return (`Bonjour, je suis ${first}. J'ai ${second} ans et j'habite ${third}.`);
}
